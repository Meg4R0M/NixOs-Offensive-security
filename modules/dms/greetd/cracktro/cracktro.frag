...
float rowByte(int g, int r){
  ...
  if(g==23) return r==0?99.0:(r==1?99.0:(r==2?99.0:(r==3?107.0:(r==4?127.0:(r==5?119.0:(r==6?99.0:(0.0)))))));
  if(g==24) return r==0?15.0:(r==1?6.0:(r==2?6.0:(r==3?6.0:(r==4?70.0:(r==5?102.0:(r==6?127.0:(0.0)))))));
  if(g==25) return r==0?30.0:(r==1?51.0:(r==2?7.0:(r==3?14.0:(r==4?56.0:(r==5?51.0:(r==6?30.0:(0.0)))))));
  if(g==26) return r==0?63.0:(r==1?102.0:(r==2?102.0:(r==3?62.0:(r==4?6.0:(r==5?6.0:(r==6?15.0:(0.0)))))));
  if(g==27) return r==0?127.0:(r==1?99.0:(r==2?49.0:(r==3?24.0:(r==4?76.0:(r==5?102.0:(r==6?127.0:(0.0)))))));
  if(g==28) return r==0?12.0:(r==1?14.0:(r==2?12.0:(r==3?12.0:(r==4?12.0:(r==5?12.0:(r==6?63.0:(0.0)))))));
  if(g==29) return r==0?30.0:(r==1?51.0:(r==2?51.0:(r==3?62.0:(r==4?48.0:(r==5?24.0:(r==6?14.0:(0.0)))))));
  if(g==30) return r==0?127.0:(r==1?70.0:(r==2?22.0:(r==3?30.0:(r==4?22.0:(r==5?6.0:(r==6?15.0:(0.0)))))));
  return 0.0;
}
int charAt(int i){
  if(i==0) return 0;
